...
const Feedback = ({
  ...
  const generateKey = (data) => {
    //Generate random key for feedback in Firebase
  ...
  return (
    <div className="feedback">
      ...
      {showFeedback && (
        <Paper elevation={4} variant="elevation" className={classes.paperStyle}>
          ...
          <form onSubmit={(e) => submitHandler(e)}>
            ...
            <div className={classes.formItems}>
              <Button
                ...
                type="submit"
                disabled={
                  !feedbackTopic || !feedbackValue || feedbackValue === ""
                }
              >
                Submit
              </Button>
